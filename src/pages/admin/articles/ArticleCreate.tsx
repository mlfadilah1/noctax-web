...
export default function ArticleCreate() {
  ...
  // Memasukkan field published_at ke state
      ...
      <form onSubmit={handleSubmit} className="bg-white dark:bg-abyss-light p-8 rounded-3xl border border-zinc-200 dark:border-white/10 shadow-lg space-y-6">
        ...
        <div>
          ...
          {isPreview ? (
            ...
            <textarea required rows={15} onChange={e => setFormData({...formData, content: e.target.value})} className="w-full p-4 rounded-xl border dark:border-white/10 bg-zinc-50 dark:bg-abyss dark:text-white font-mono text-sm leading-relaxed" placeholder="Tulis catatan DevLog di sini..."></textarea>
          )}
        </div>
