          ...
          <div className="w-full max-w-4xl grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 mb-12 text-left">
            <div className="p-5 bg-white dark:bg-abyss-light border border-zinc-200 dark:border-white/10 rounded-2xl shadow-sm">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <span className="flex items-center gap-1.5 px-3 py-1.5 bg-techblue/10 text-techblue rounded-lg text-sm font-medium"><Smartphone className="w-3.5 h-3.5" /> Kotlin (Android API)</span>
            ...
            <div className="p-5 bg-white dark:bg-abyss-light border border-zinc-200 dark:border-white/10 rounded-2xl shadow-sm">
              ...
              <div className="flex flex-wrap gap-2">
                <span className="flex items-center gap-1.5 px-3 py-1.5 bg-techblue/10 text-techblue rounded-lg text-sm font-medium"><Layout className="w-3.5 h-3.5" /> Figma (Basic)</span>
                <span className="flex items-center gap-1.5 px-3 py-1.5 bg-zinc-100 dark:bg-white/5 text-zinc-700 dark:text-zinc-300 border border-zinc-200 dark:border-white/5 rounded-lg text-sm font-medium"><Brush className="w-3.5 h-3.5" /> Canva (Middle)</span>
                <span className="flex items-center gap-1.5 px-3 py-1.5 bg-zinc-100 dark:bg-white/5 text-zinc-700 dark:text-zinc-300 border border-zinc-200 dark:border-white/5 rounded-lg text-sm font-medium"><PenTool className="w-3.5 h-3.5" /> CorelDraw (Basic)</span>
                <span className="flex items-center gap-1.5 px-3 py-1.5 bg-zinc-100 dark:bg-white/5 text-zinc-700 dark:text-zinc-300 border border-zinc-200 dark:border-white/5 rounded-lg text-sm font-medium"><ImageIcon className="w-3.5 h-3.5" /> Photoshop (Basic)</span>
              </div>
            </div>
            ...
            <div className="p-5 bg-white dark:bg-abyss-light border border-zinc-200 dark:border-white/10 rounded-2xl shadow-sm">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <span className="flex items-center gap-1.5 px-3 py-1.5 bg-zinc-100 dark:bg-white/5 text-zinc-600 dark:text-zinc-400 border border-zinc-200 dark:border-white/5 rounded-lg text-sm font-medium"><Network className="w-3.5 h-3.5" /> Comp Networking</span>
