    ...
    <div className="min-h-screen flex flex-col transition-colors duration-300 bg-zinc-50 dark:bg-abyss relative">
      ...
      <footer className="border-t border-zinc-200 dark:border-white/10 py-12 md:py-16 mt-16 bg-white dark:bg-abyss-dark transition-colors">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center md:items-start gap-8 md:gap-10">
          ...
          {/* Bagian Kiri: Info & Copyright (Desktop) */}
          ...
          {/* Bagian Kanan: Sosial Media & Copyright (Mobile) */}
          <div className="flex flex-col items-center md:items-end gap-5 w-full md:w-auto">
            ...
            <div className="flex items-center justify-center md:justify-end gap-4 w-full flex-wrap">
              ...
              {/* LinkedIn - BARU DITAMBAHKAN */}
              <a href="https://www.linkedin.com/in/muhammad-lutfi-fadilah-7792502a5/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="p-3.5 md:p-3 rounded-full bg-zinc-100 dark:bg-white/5 text-zinc-600 dark:text-zinc-400 hover:bg-[#0077b5] hover:text-white active:scale-95 transition-all shadow-sm">
                <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
              </a>

              {/* Email */}
              <a href="mailto:noctaxstudio@gmail.com" aria-label="Email" className="p-3.5 md:p-3 rounded-full bg-zinc-100 dark:bg-white/5 text-zinc-600 dark:text-zinc-400 hover:bg-techblue hover:text-white active:scale-95 transition-all shadow-sm">
